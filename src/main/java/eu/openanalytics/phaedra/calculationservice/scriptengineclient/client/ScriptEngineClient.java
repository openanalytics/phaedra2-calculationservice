...
public class ScriptEngineClient implements MessageListener {
    ...
    public ScriptEngineClient(ScriptEngineClientConfiguration clientConfig, RabbitTemplate rabbitTemplate) {
